...
var observeRequest = function (dataProvider, options) { return function (type, resourceName, params) {
        ...
        subscribe: function (observer) {
            ...
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, firebaseDataProvider_1.fb.GetResource(resourceName)];
                        case 1:
                            resourceObj = _a.sent();
                            subscription = resourceObj.observable.subscribe(function () {
